...
import StatusHandler from "../../pages/OrderTrackingPage/StatusHandler";
import { BiHeart, BiX, BiCheck } from "react-icons/bi";
        ...
        {notification && (
          <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50">
            ...
            justify-center gap-1 animate-in fade-in slide-in-from-right duration-300 max-w-md">
              <BiCheck className="text-4xl font-bold shrink-0" />
