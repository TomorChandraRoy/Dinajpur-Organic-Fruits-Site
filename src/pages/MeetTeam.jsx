...
const teamMembers = [
  {
    ...
    image: Tomor,
    description:
      "Expert in full-stack development with 3+ years of experience building scalable web applications.",
  },
  {
    name: "Shuvo Adhikari",
    role: "Founder Of CEO",
    image: Shuvo,
    description:
      "Specializes in Node.js and cloud infrastructure, ensuring performance and reliability.",
  }
];
  ...
  return (
   <div className="">
      <div className="mx-auto">
        <div className="mx-auto text-center py-20 px-6 bg-[#1b2d24] text-white ">
          <h2 className="text-3xl md:text-4xl font-bold">Meet our team</h2>
          <p className="text-[15px] mt-6 leading-relaxed">We’re a group of passionate professionals committed to building high-quality digital solutions. Our diverse skills and collaborative spirit drive innovation.</p>
        </div>

      <div className="lg:p-6 md:p-4 grid lg:grid-cols-2 md:grid-cols-2  gap-8 max-md:justify-center mt-4 lg:max-w-3xl max-md:max-w-xs mx-auto">
