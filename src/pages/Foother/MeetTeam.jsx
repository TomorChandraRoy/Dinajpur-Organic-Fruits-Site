import meetTeamData from "../../utils/data/meetTeamData.json";

const MeetTeam = () => {
  const { heading, teamMembers } = meetTeamData;

  return (
    <div className="">
      <div className="mx-auto">
        <div className="mx-auto text-center py-20 px-6 bg-[#1b2d24] text-white ">
          <h2 className="text-3xl md:text-4xl font-bold">{heading.title}</h2>
