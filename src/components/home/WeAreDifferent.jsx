  ...
  return (
    <>
      ...
      <section className=" px-6 bg-gray-50/50 overflow-hidden">
        <h2 className="text-3xl font-bold text-center uppercase border-b-2 border-emerald-700 w-fit
        ...
        <div className="max-w-[1200px] mx-auto space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-xl min-h-[450px] flex items-end ">
              ...
              bg-gradient-to-t from-black/80 via-black/20 to-transparent w-full">
                <span className="inline-block px-4 py-1.5 mb-4 bg-emerald-700 text-white rounded-full
                text-sm font-bold">
                  {data.hero.subtitle}
                </span>
                ...
                >
                  {data.features.map((feature, index) => (
                    <SwiperSlide key={index} className="pt-12 pb-4">
                      <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex
                      flex-col items-center text-center h-full relative">
                        ...
                        <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-20">
                          <div className=" rounded-full px-4 py-1.5 shadow-lg bg-emerald-700 flex
